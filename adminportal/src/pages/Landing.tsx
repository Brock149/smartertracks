      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 text-xl text-gray-600">
              Download the Smarter Tracks <strong>mobile tool tracking app</strong> for field
              technicians. Access your tool inventory, transfer tools, and run audits right from
              the job site.
            </p>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <dl className="mt-10 space-y-8">
            ...
            <div>
              ...
              <dd className="mt-2 text-gray-600">
                Yes. Smarter Tracks has a native iOS <strong>tool tracking app</strong> available on the
                App Store, with Android support coming soon. Field techs can scan tools, transfer

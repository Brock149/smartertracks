  ...
  return (
    <div className="min-h-screen bg-white text-gray-800 py-10 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="mb-4">
          These terms and conditions apply to the Smarter Tracks app (hereby referred to as
          <strong> "Application"</strong>) for mobile devices that was created by BAC Tech (hereby
          referred to as <strong>"Service Provider"</strong>) as a Free service.
        </p>
        ...
        <p className="mb-4">
          ...
          and other intellectual property rights related to the Application remain the property of
        ...
        <p className="mb-4">
          ...
          and limitations imposed by the official operating system of your device. Such actions could
        ...
        <p className="mb-4">
          ...
          and Conditions. Below is the link to the Terms and Conditions of the third-party service
        ...
        <p className="mb-4">
          ...
          payer for the device on which you are using the Application, we assume that you have
        ...
        <p className="mb-4">
          ...
          system version installed on your device. However, you agree to always accept updates to the
          Application when offered to you. The Service Provider may also wish to cease providing the
          Application and may terminate its use at any time without providing termination notice to
          you. Unless they inform you otherwise, upon any termination: (a) the rights and licenses
          granted to you in these terms will end; (b) you must cease using the Application, and (if
        ...
        <p className="mb-4">These terms and conditions are effective as of 2025-07-10.</p>

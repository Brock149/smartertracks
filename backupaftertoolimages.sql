...
CREATE POLICY "Admins can do anything" ON "public"."tool_images" USING ((EXISTS ( SELECT 1
   FROM "public"."users"
...
CREATE POLICY "Users can delete images for their tools" ON "public"."tool_images" FOR DELETE USING ((EXISTS ( SELECT 1
   FROM "public"."tools"
  WHERE (("tools"."id" = "tool_images"."tool_id") AND ("tools"."current_owner" = "auth"."uid"())))));



CREATE POLICY "Users can insert images for their tools" ON "public"."tool_images" FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."tools"
  WHERE (("tools"."id" = "tool_images"."tool_id") AND ("tools"."current_owner" = "auth"."uid"())))));
...
CREATE POLICY "Users can view images for their tools" ON "public"."tool_images" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."tools"
  WHERE (("tools"."id" = "tool_images"."tool_id") AND ("tools"."current_owner" = "auth"."uid"())))));
